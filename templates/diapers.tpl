...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<div id="diagram">
			<form id="bscForm" class="box" name="bscForm" action="./index.php?page=lightbox&action=dia_pers&id_bsc={bsc->GetIdentifier}&id_pers={pers->GetIdentifier}" method="post">
				<fieldset>
					<p>BSC: {bsc->GetName}</p>
					<p>Perspektive: {pers->GetName}</p>
